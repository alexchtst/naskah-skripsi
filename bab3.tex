...
\section{Alat dan Bahan}
	...
	Perangkat keras terdiri dari sebuah single board computer (SBC) yang digunakan
	sebagai host IoT hub serta sejumlah sensor dan aktuator untuk simulasi pengambilan
	data. Detail mengenai perangkat keras yang digunakan terdapat pada daftar berikut.
	...
	Perangkat lunak yang digunakan selama proses pengembangan mencakup ling-
	kungan kerja dan lingkungan uji. Detail mengenai perangkat lunak yang digunakan ter-
	dapat pada daftar berikut.
