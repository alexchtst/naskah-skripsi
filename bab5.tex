...
\begin{enumerate}
    \item Model CNN berhasil diimplementasikan pada board FPGA menggunakan representasi fixed-point 16-bit. Proses kuantisasi dilakukan terhadap parameter bobot dan bias model sehingga dapat digunakan pada modul Verilog tanpa menggunakan operasi floating-point.
